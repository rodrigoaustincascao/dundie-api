...
async def get_user_if_change_password_is_allowed(
    ...
    """
        ...
        try:
            valid_pwd_reset_token = get_current_user(
                token=pwd_reset_token or "") == target_user
        ...
        if any(
            [
                ...
                authenticated_user.superuser and authenticated_user,
                authenticated_user == authenticate_user.id == target_user.id,
